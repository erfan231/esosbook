...
from esosbook.forms import PostForm, UpdateForm, LoginForm, RegisterForm, ResetPasswordForm, RequestPasswordResetForm
from esosbook import app, db, login_manager
...
def send_reset_email(user):
    ...
    msg = Message("Password Reset Request", sender="esosbook@gmail.com",
